...
<div class="row">
<div class="col-lg-6">
<span class="logo">Computer Science</span></div>
...
include_once 'config.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="profile.php" class="log log1">'.$lname.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
</div>
</div></div>
<div class="bg">
...
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$lname.'</td><td>'.$fname.'</td><td>'.$phone.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
?>
