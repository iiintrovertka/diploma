...
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$fname.'</td><td>'.$lname.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b> </b></td><td><b>Phone</b></td><td><b>Email</b></td><td><b>Delete</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$fname = $row['fname'];
	$lname = $row['lname'];
  ...
  $email = $row['email'];
	...
	echo '<tr><td>'.$c++.'</td><td>'.$fname.'</td><td>'.$lname.'</td><td>'.$phone.'</td><td>'.$email.'</td>
